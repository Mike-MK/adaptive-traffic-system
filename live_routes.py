...
def generate_routefile():
    ...
    with open("live_routes/live{}.rou.xml".format(time.time()), "w") as routes:
        print(
            """
            <routes>
...
if __name__ == "__main__":
    #iterate files in live_traffic_data dir
    for entry in os.scandir('live_traffic_data'): 
        #create .rou for each file
